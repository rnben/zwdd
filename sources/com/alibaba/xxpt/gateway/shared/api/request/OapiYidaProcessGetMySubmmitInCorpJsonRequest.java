...
import com.alibaba.xxpt.gateway.shared.api.response.OapiYidaProcessGetMySubmmitInCorpJsonResponse;
import com.alibaba.xxpt.gateway.shared.client.http.api.OapiRequest;

/* loaded from: zwdd-sdk-java-1.2.0.jar:com/alibaba/xxpt/gateway/shared/api/request/OapiYidaProcessGetMySubmmitInCorpJsonRequest.class */
public class OapiYidaProcessGetMySubmmitInCorpJsonRequest extends OapiRequest<OapiYidaProcessGetMySubmmitInCorpJsonResponse> {
    ...
    public final String getApiUrl() {
        return "/yida/process/getMySubmmitInCorp.json";
    }
    ...
    public Class<OapiYidaProcessGetMySubmmitInCorpJsonResponse> getResponseClass() {
        return OapiYidaProcessGetMySubmmitInCorpJsonResponse.class;
    }

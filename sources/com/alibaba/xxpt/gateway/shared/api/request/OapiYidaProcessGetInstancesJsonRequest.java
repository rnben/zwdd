...
import com.alibaba.xxpt.gateway.shared.api.response.OapiYidaProcessGetInstancesJsonResponse;
import com.alibaba.xxpt.gateway.shared.client.http.api.OapiRequest;

/* loaded from: zwdd-sdk-java-1.2.0.jar:com/alibaba/xxpt/gateway/shared/api/request/OapiYidaProcessGetInstancesJsonRequest.class */
public class OapiYidaProcessGetInstancesJsonRequest extends OapiRequest<OapiYidaProcessGetInstancesJsonResponse> {
    ...
    public final String getApiUrl() {
        return "/yida/process/getInstances.json";
    }
    ...
    public Class<OapiYidaProcessGetInstancesJsonResponse> getResponseClass() {
        return OapiYidaProcessGetInstancesJsonResponse.class;
    }

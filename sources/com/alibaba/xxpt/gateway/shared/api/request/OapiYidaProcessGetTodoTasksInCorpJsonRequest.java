...
import com.alibaba.xxpt.gateway.shared.api.response.OapiYidaProcessGetTodoTasksInCorpJsonResponse;
import com.alibaba.xxpt.gateway.shared.client.http.api.OapiRequest;

/* loaded from: zwdd-sdk-java-1.2.0.jar:com/alibaba/xxpt/gateway/shared/api/request/OapiYidaProcessGetTodoTasksInCorpJsonRequest.class */
public class OapiYidaProcessGetTodoTasksInCorpJsonRequest extends OapiRequest<OapiYidaProcessGetTodoTasksInCorpJsonResponse> {
    ...
    public final String getApiUrl() {
        return "/yida/process/getTodoTasksInCorp.json";
    }
    ...
    public Class<OapiYidaProcessGetTodoTasksInCorpJsonResponse> getResponseClass() {
        return OapiYidaProcessGetTodoTasksInCorpJsonResponse.class;
    }

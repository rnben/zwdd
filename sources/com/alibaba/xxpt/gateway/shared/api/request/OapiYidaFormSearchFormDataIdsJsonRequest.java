...
import com.alibaba.xxpt.gateway.shared.api.response.OapiYidaFormSearchFormDataIdsJsonResponse;
import com.alibaba.xxpt.gateway.shared.client.http.api.OapiRequest;

/* loaded from: zwdd-sdk-java-1.2.0.jar:com/alibaba/xxpt/gateway/shared/api/request/OapiYidaFormSearchFormDataIdsJsonRequest.class */
public class OapiYidaFormSearchFormDataIdsJsonRequest extends OapiRequest<OapiYidaFormSearchFormDataIdsJsonResponse> {
    ...
    public Class<OapiYidaFormSearchFormDataIdsJsonResponse> getResponseClass() {
        return OapiYidaFormSearchFormDataIdsJsonResponse.class;
    }
